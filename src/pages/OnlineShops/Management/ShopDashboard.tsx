...
const ShopDashboard: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<'general' | 'design' | 'categories' | 'products' | 'customers' | 'orders' | 'shipping' | 'footer'>('general');
      ...
      <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
        <div className="border-b border-slate-200 flex">
            ...
            <button 
                ...
                className={`px-6 py-4 text-sm font-medium border-b-2 transition-colors flex items-center ${activeTab === 'footer' ? 'border-red-600 text-red-600' : 'border-transparent text-slate-500 hover:text-slate-700'}`}
            >
                <Layout size={16} className="mr-2" /> Footer & Rechtliches
            </button>
        </div>
                        ...
                        <div className="space-y-6">
                            ...
                            <div>
                                ...
                                <div className="flex items-center space-x-2 mb-2">
                                    <input 
                                        ...
                                        value={shop.footer_logo_url || ''}
                                        onChange={(e) => setShop({ ...shop, footer_logo_url: e.target.value })}
                                        placeholder="URL oder Upload..."
                                    />
                                    {shop.footer_logo_url && (
                                        <button 
                                            onClick={() => setShop({ ...shop, footer_logo_url: '' })}
                                            ...
                                            onChange={async (e) => {
                                                ...
                                                try {
                                                    ...
                                                    if (data.success && data.files?.preview?.[0]) {
                                                        ...
                                                        setShop({ ...shop, footer_logo_url: url });
                                                    }
                                ...
                                {shop.footer_logo_url && (
                                    <div className="mt-2 p-2 bg-slate-800 rounded">
                                        <img src={shop.footer_logo_url} className="h-10 object-contain" alt="Footer Logo" />
                                    </div>
                                )}
                            </div>
                            ...
                            <div>
                                ...
                                <textarea 
                                    ...
                                    value={shop.contact_address || ''}
                                    onChange={(e) => setShop({ ...shop, contact_address: e.target.value })}
                            ...
                            <div className="space-y-3 pt-4 border-t border-slate-100">
                                ...
                                <div className="flex items-center space-x-2">
                                    ...
                                    <input 
                                        type="text" 
                                        className="flex-1 border border-slate-300 rounded-lg p-2 text-sm"
                                        value={shop.social_instagram || ''}
                                        onChange={(e) => setShop({ ...shop, social_instagram: e.target.value })}
                                ...
                                <div className="flex items-center space-x-2">
                                    ...
                                    <input 
                                        type="text" 
                                        className="flex-1 border border-slate-300 rounded-lg p-2 text-sm"
                                        value={shop.social_tiktok || ''}
                                        onChange={(e) => setShop({ ...shop, social_tiktok: e.target.value })}
                                ...
                                <div className="flex items-center space-x-2">
                                    ...
                                    <input 
                                        type="text" 
                                        className="flex-1 border border-slate-300 rounded-lg p-2 text-sm"
                                        value={shop.social_whatsapp || ''}
                                        onChange={(e) => setShop({ ...shop, social_whatsapp: e.target.value })}
                                ...
                                {([
                                    ...
                                    <div key={page.key}>
                                        ...
                                        <textarea 
                                            ...
                                            value={shop[page.key] || ''}
                                            onChange={(e) => setShop({ ...shop, [page.key]: e.target.value })}
