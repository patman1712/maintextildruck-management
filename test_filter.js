...
const db = require('./api/db.ts').default;

// 1. Create Test Data
const customerId = 'test-customer-filter';
const shopId = 'test-shop-filter';
...
try {
    ...
    // Insert Shop
    db.prepare("INSERT INTO shops (id, customer_id, name, domain_slug) VALUES (?, ?, 'Test Shop', 'test-shop')").run(shopId, customerId);
